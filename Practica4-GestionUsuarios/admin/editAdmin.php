                    ...
                    <section id="content">
                        <section class="vbox">
                            <section class="scrollable padder">
                                <br/>
                                <!--<form action="phpUpdateAdmin.php" method="post" enctype="multipart/form-data">
                                    <h2>Update user</h2><br/>
                                    <input type="email" placeholder="Email" id="email" name="email" value="<?php echo $user->getEmail(); ?>"><br/>
                                    <input type="password" placeholder="Password" id="contrasena" name="contrasena" value=""><br/>
                                    <input type="text" placeholder="Alias" id="alias" name="alias" value="<?php echo $user->getAlias(); ?>" ><br/>
                                    <input type="checkbox" id="activo" name="activo" <?php seleccionar($user->getActivo()); ?> >Active<br/>
                                    <input type="checkbox" id="admin" name="admin" <?php seleccionar($user->getAdministrador()); ?> > Admin<br/>
                                    <input type="checkbox" id="personal" name="personal" <?php seleccionar($user->getPersonal()); ?> > Staff<br/>
                                ...
                                <section class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="bs-example form-horizontal" action="phpUpdateAdmin.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <label class="checkbox-inline i-checks">
                                                        <input type="checkbox" id="admin" name="admin" <?php seleccionar($user->getAdministrador()); ?>/><i></i>Admin
                                                    </label>
                                                    <label class="checkbox-inline i-checks">
