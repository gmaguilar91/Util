                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav nav-main" data-ride="collapse">
                    ...
                    <li >
                      ...
                      <ul class="nav dk">
                        <li >
                            <a href="table-datatable.php" class="auto">                            
                            <span class="pull-right text-muted">
                              <i class="i i-circle-sm-o text"></i>
                              <i class="i i-circle-sm text-active"></i>
                            </span>                            
              ...
              <section class="panel panel-default">
                ...
                <div class="table-responsive">
                  <table class="table table-striped m-b-none">
                    <thead>
                      <tr>
                        <th width="20%">[Campo1]</th>
                        <th width="25%">[Campo2]</th>
                        <th width="25%">[Campo3]</th>
                        <th width="15%">[Campo4]</th>
                        <th width="15%">[Campo5]</th>
                      </tr>
                    </thead>
                    <tbody>
                        <!-- Php code here-->
                        <tr>
                            <td width="20%">[Campo1]</td>
                            <td width="25%">[Campo2]</td>
                            <td width="25%">[Campo3]</td>
                            <td width="15%">[Campo4]</td>
                            <td width="15%">[Campo5]</td>
                        </tr>
                    </tbody>
                  </table>
                    <br/>
                    <form action="../pages/phpNewUser.php" method="post" enctype="multipart/form-data">
                        <h2>New user</h2><br/>
                        <input type="text" placeholder="Email" id="email" name="email"><br/>
                        <input type="password" placeholder="Password" id="contrasena" name="contrasena"><br/>
                        <input type="checkbox" id="activo" name="activo">Active<br/>
                        <input type="checkbox" id="admin" name="admin">Admin<br/>
                        <input type="checkbox" id="personal" name="personal">Staff<br/>
