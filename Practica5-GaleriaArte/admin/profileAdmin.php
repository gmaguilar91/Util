                                        ...
                                        <section class="vbox">
                                            <section class="scrollable">
                                                ...
                                                <section class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <form class="bs-example form-horizontal" action="phpEditmyProfileAdmin.php" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <label class="checkbox-inline i-checks">
                                                                        <input type="checkbox" id="admin" name="admin" <?php seleccionar($usuario->getAdministrador()); ?>/><i></i>Admin
                                                                    </label>
                                                                    <label class="checkbox-inline i-checks">
