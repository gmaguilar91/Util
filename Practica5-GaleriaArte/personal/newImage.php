                        ...
                        <section class="vbox">
                            <section class="scrollable padder">
                                ...
                                <section class="panel panel-default">
                                    <header class="panel-heading font-bold">New Image</header>
                                    <div class="panel-body">
                                        <form class="bs-example form-horizontal" action="../pages/phpNewImage.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="radio i-checks">
                                                        <label>
                                                            <input type="radio" name="category" value="Portrait" checked="">
                                                            <i></i> Portrait
                                                        </label>
                                                    </div>
                                                    <div class="radio i-checks">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="file" class="filestyle" data-icon="false" data-classButton="btn btn-default" data-classInput="form-control inline v-middle input-s"  id="imgGaleria" name="imgGaleria" accept="image/*">
                                                </div>
                                            </div>
                                            <br>
                                            <input type="hidden" value="<?php echo $email ?>" name="pkEmail" id="pkEmail">
                                            <input type="hidden" value="personal/newImage.php" name="lastPage" id="lastPage">
                                            <div class="form-group">
                                                <div class="col-lg-offset-2 col-lg-10">
                                                    <button type="submit" class="btn btn-sm btn-default">Publish image</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
