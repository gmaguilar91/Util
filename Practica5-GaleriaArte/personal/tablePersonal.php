                            ...
                            <section class="scrollable padder">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <tr><td width="20%"><?php echo $user->getEmail(); ?></td>
                                                        ...
                                                        <td width="15%">
                                                            <form action="editPersonal.php" method="post" enctype="multipart/form-data">
                                                                <button type="submit" value="<?php echo $user->getEmail(); ?>" name="edit">Edit</button>
                                                            </form>
                                                        </td>
                                                        <td width="15%">
                                                            <form action="phpDelete.php" method="post" enctype="multipart/form-data">
                                                                <button type="submit" id="botonBorrar" name="botonBorrar" value="<?php echo $user->getEmail(); ?>" class="borrar">Delete</button>
                                                                <input type="text" name="paginaAnterior" id="paginaAnterior" value="tableAdmin" hidden/>
                                                            </form>
                                                        </td></tr>
                                                <?php } ?>
                                ...
                                <section class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <form class="form-inline" action="phpNewUserPersonal.php" method="post" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <label class="sr-only" for="email">Email address</label>
                                                        <input type="email" class="form-control" id="email" name="email" placeholder="Email">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="sr-only" for="contrasena">Password</label>
                                                        <input type="password" class="form-control" id="contrasena" name="contrasena" placeholder="Password">
                                                    </div>
                                                    <div class="checkbox m-l m-r-xs">
                                                        <label class="i-checks">
                                                          <input type="checkbox" id="activo" name="activo"/><i></i>Active &nbsp;&nbsp;&nbsp;
                                                        </label>
                                                        <label class="i-checks">
                                                          <input type="checkbox" id="admin" name="admin" disabled/><i></i>Admin &nbsp;&nbsp;&nbsp;
                                                        </label>
                                                        <label class="i-checks">
                                                          <input type="checkbox" id="personal" name="personal"/><i></i>Staff &nbsp;&nbsp;&nbsp; 
                                                        </label>
                                                    </div>
