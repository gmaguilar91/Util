        ...
        <div id="imagen_central">
            ...
            <div style="padding-top:1%; padding-bottom:2%; width:99%; text-align:justify;">
                ...
                <div style="margin-left: 2%;  width: 90%;">
                    <form name="Formulario_validacion"  class="tabla_formulario" style="padding: 0.5em; width: 99%; background-color: #f5f5f5;" title="Identificación sin Certificado Digital" method="post" action="phpSasSubir.php" enctype="multipart/form-data" >
                        ...
                        <fieldset style="border: 0px;" title="Imágenes tele diagnóstico">
                            ...
                            <div style="position:relative; left:15%;">
                                <input type="button" class="boton" id="btSubir" value="Agregar" multiple/>
                            </div>
